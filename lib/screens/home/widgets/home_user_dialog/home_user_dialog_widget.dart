...
class _HomeUserDialog extends State<HomeUserDialog> {
  ...
  void initState() {
    super.initState();
    context
        .read<SignalUserStateBloc>()
        .add(SignalUserStateGetEvent(widget.userIdx));
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                // else
                                //   Container(),
                                if (state.userProfile.interest?.isNotEmpty ==
                                    true)
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        top: Sizes.size32),
                                ...
                                SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Gaps.v3,
                                      Text(
                                          '선호음식: ${state.userProfile.taste ?? '없음'}'),
                                      Gaps.v3,
                                      Text(
                                          '선호장소: ${state.userProfile.preferArea ?? '없음'}'),
                                      Gaps.v3,
                                      Text(
                                          'MBTI: ${state.userProfile.mbti ?? '비밀'}'),
                                    ],
                                  ),
                                ),
                                Gaps.v20,
