...
import 'package:honbap_signal_flutter/screens/home/widgets/home_signalList_box_widget.dart';
               ...
               child: Container(
                 ...
                 child: Column(
                   ...
                   children: [
                     ...
                     InkWell(
                       onTap: () => showDialog(context: context, builder: (_) => const SignalOnDialog(), barrierDismissible: false),
                       child: SignalBox(signal: snapshot.data!.signal!,),
                     ),
                     ...
                     ListView.builder(
                       shrinkWrap: true,
                       physics: const NeverScrollableScrollPhysics(), //scrollable off
                       itemCount: snapshot.data!.signalToMe!.length,
                       itemBuilder: (BuildContext context, int index) {
                         return SizedBox(
                           height: 47,
                           child: SignalListBox(name: snapshot.data!.signalToMe![index].name!, imgUri: snapshot.data!.signalToMe![index].image!),
                         );
                       },
                     )
                     : Container(
                     ...
                     ListView.builder(
                       ...
                       itemBuilder: (BuildContext context, int index) {
                         return SizedBox(
                           height: 47,
                           child: SignalListBox(name: snapshot.data!.signalRequest![index].name!, imgUri: snapshot.data!.signalRequest![index].image!),
                         );
                       },
                     )
                   ],
